...
const mockAppointments: Appointment[] = [
  { id: 1, date: "2026-04-14", startTime: "09:00", endTime: "10:00", patient: "rayen braiek", type: "Routine check-up", notes: "" },
  ...
  { id: 7, date: "2026-04-18", startTime: "09:00", endTime: "10:00", patient: "rayen braiek", type: "Routine check-up", notes: "" },
];
              ...
              <div className="grid gap-4 py-4">
                <div><Label>Patient</Label>
                  <Select><SelectTrigger className="mt-1.5"><SelectValue placeholder="Select patient" /></SelectTrigger>
                    <SelectContent>
                      <SelectItem value="1">rayen braiek</SelectItem>
